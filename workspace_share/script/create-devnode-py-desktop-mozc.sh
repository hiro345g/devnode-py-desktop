...
sed -i 's/devnode-py-desktop/devnode-py-desktop-mozc/' ${DIST_DIR}/.devcontainer/devcontainer.json
sed -i 's/devnode-py-desktop/devnode-py-desktop-mozc/' ${DIST_DIR}/docker-compose.yml
